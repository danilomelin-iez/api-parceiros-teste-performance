...
export function lerContratoNotaFiscalData () {
  const token =
  ...
  const url =
    "https://api-teste.ieztelecom.net.br/api/v1/cliente/contrato/c1a015d8-7204-49c0-b46b-0ce913b3605b/nf?data=2025-08-21";
