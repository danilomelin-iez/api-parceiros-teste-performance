...
export const options = {
  ...
  cloud: {
    projectID: "3768735",
    name: "Ler Consumo Diário Datas",
    tags: {
      teste: "ler-consumo-diario-datas",
      tipo: "GET",
...
export default function () {
  ...
  const url =
    "https://api-teste.ieztelecom.net.br/api/v1/cliente/contrato/linha/658629e4-6add-42ca-9ca9-83b66653a3d4/consumo_detalhado?mes=2&ano=2025";
