...
export const options = {
  ...
  cloud: {
    projectID: "3768735",
    name: "Ler Lista Aparelhos Fabricantes",
    tags: {
      teste: "ler-lista-aparelhos-fabricantes",
      tipo: "GET",
...
export default function () {
  ...
  const url =
    "https://api-teste.ieztelecom.net.br/api/v1/crm/aparelhos/fabricante/9f8276a1-0732-4d99-b91e-7b9f8e1a09d0";
