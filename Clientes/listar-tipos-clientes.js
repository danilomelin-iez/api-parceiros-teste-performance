...
export const options = {
  ...
  insecureSkipTLSVerify: true,
    cloud: {
      projectID: '3768735',
      name: 'Listar Tipos de Clientes',
      tags: {
        teste: 'listar-tipos-clientes',
        tipo: 'GET',
