...
export const options = {
  ...
  cloud: {
    projectID: "3768735",
    name: "Ler Linha Datas",
    tags: {
      teste: "ler-linha-datas",
      tipo: "GET",
...
export default function () {
  ...
  const url =
    "https://api-teste.ieztelecom.net.br/api/v1/cliente/contrato/linha/930e6d95-47f7-4f9b-b3c7-26b78df45a73/consumo?data_inicial=2024-04-01&data_final=2024-04-24";
