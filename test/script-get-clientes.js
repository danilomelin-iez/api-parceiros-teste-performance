...
export default function () {
  ...
  const requests = [
    {
      name: "Obeter Cliente",
      url: "https://api-teste.ieztelecom.net.br/api/v1/cliente/b41c2810-4aa9-4c72-b7f2-692cb8cb5e76",
    },
    {
      name: "Listar Tipos de Cliente",
      url: "https://api-teste.ieztelecom.net.br/api/v1/cliente/tipos",
    },
  ];
